    ...
    >
        <div class="pointer-events-auto bg-white/95 dark:bg-surface-800/95 backdrop-blur-xl border border-theme-100 dark:border-surface-600 p-3 sm:p-2 sm:pr-3 sm:pl-4 rounded-xl sm:rounded-2xl shadow-2xl shadow-theme-500/10 dark:shadow-black/50 flex flex-col sm:flex-row items-center gap-3 sm:gap-8 w-full sm:w-auto max-w-md sm:max-w-2xl ring-1 ring-theme-500/10 dark:ring-surface-500/30 transform transition-all">
            ...
            <div class="flex items-center gap-2 w-full sm:w-auto">
                ...
                <button 
                    @click="cancelChanges()"
                    class="hidden sm:flex items-center gap-2 px-4 py-2 text-sm font-medium text-surface-500 hover:text-surface-700 dark:text-surface-400 dark:hover:text-surface-200 transition-colors"
                >
                ...
                <button 
                    ...
                    class="w-full sm:w-auto group flex items-center justify-center gap-2 px-4 py-2.5 bg-theme-gradient text-white rounded-lg sm:rounded-xl text-sm font-semibold shadow-lg shadow-theme-500/20 hover:shadow-theme-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
                >
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\profile\partials\bulk-action-bar.blade.php ENDPATH**/ ?>