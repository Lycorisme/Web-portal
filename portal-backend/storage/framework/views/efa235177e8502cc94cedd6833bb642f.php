            ...
            <div class="max-w-4xl space-y-6">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <span class="px-3 py-1 bg-emerald-500 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded">
                        <?php echo e($article->categoryRelation?->name ?? 'Artikel'); ?>
                    ...
                    <div class="flex items-center gap-2 text-slate-300 text-sm font-medium">
                        ...
                        <?php echo e(\Carbon\Carbon::parse($article->published_at)->translatedFormat('d F Y')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->author): ?>
                    <div class="flex items-center gap-4 pt-4">
                        <div class="relative">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($article->author->profile_photo_url)): ?>
                                <img src="<?php echo e($article->author->profile_photo_url); ?>" class="w-12 h-12 rounded-full border-2 border-emerald-500/50 object-cover">
                            <?php else: ?>
...
</section><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\article\partials\hero-section.blade.php ENDPATH**/ ?>