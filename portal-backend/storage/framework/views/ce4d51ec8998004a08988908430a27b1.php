        ...
        <div x-show="isOpen"
            ...
            <div class="max-h-[55vh] overflow-y-auto overscroll-contain">
                <div class="cp-tab-content"
                    ...
                    <?php echo $__env->make('partials.command-palette.results', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views/partials/command-palette/template.blade.php ENDPATH**/ ?>