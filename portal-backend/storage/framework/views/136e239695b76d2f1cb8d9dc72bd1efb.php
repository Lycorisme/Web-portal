...
function activityLogApp() {
    return {
        ...
        // CRUD MODULE
        // ========================================
        <?php echo $__env->make('activity-log.partials.scripts.crud', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // BULK ACTIONS MODULE
        // ========================================
        <?php echo $__env->make('activity-log.partials.scripts.bulk-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // AUTO DELETE MODULE
        // ========================================
        <?php echo $__env->make('activity-log.partials.scripts.auto-delete', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // HELPERS MODULE
        // ========================================
        <?php echo $__env->make('activity-log.partials.scripts.helpers', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        async fetchLogs() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('activity-log.data')); ?>?${params}`);
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\activity-log\partials\scripts.blade.php ENDPATH**/ ?>