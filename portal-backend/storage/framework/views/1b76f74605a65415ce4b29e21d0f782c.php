    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex-shrink-0 flex items-center gap-3">
                <a href="<?php echo e(route('public.home')); ?>" class="group flex items-center gap-2.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($siteSettings['logo_url']) && $siteSettings['logo_url']): ?>
                        <div class="relative">
                            ...
                            <img class="relative h-11 w-auto" src="<?php echo e($siteSettings['logo_url']); ?>" alt="<?php echo e($siteSettings['site_name']); ?>">
                        </div>
                    <?php else: ?>
                    ...
                    <div class="hidden md:block">
                        <h1 class="text-2xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-indigo-800 to-slate-900 group-hover:from-indigo-600 group-hover:via-pink-500 group-hover:to-orange-500 transition-all duration-500">
                            <?php echo e($siteSettings['site_name'] ?? 'PORTAL'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                    ...
                    <a href="<?php echo e(route($item['route'])); ?>" 
                       class="relative px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 overflow-hidden group 
                              <?php echo e(request()->routeIs($item['route'].'*') ? 'text-white shadow-md' : 'text-slate-600 hover:text-indigo-600'); ?>">
            ...
            <div class="flex items-center gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="hidden md:flex relative group">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="hidden md:flex relative group">
    ...
    <div x-show="mobileMenu" 
        ...
        <div class="bg-white/80 backdrop-blur-2xl rounded-3xl p-6 shadow-2xl shadow-indigo-500/20 border border-white/50 space-y-4">
             <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                ...
                <a href="<?php echo e(route($item['route'])); ?>" class="flex items-center gap-4 p-4 rounded-2xl transition-all group <?php echo e(request()->routeIs($item['route'].'*') ? 'bg-slate-50 md:bg-white border-2 border-indigo-100' : 'hover:bg-indigo-50/50'); ?>">
                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br <?php echo e($item['color']); ?> flex items-center justify-center text-white text-lg shadow-lg group-hover:scale-110 transition-transform">
                        <i class="fas <?php echo e($item['icon']); ?>"></i>
                    </div>
                    <div>
                        <h4 class="font-bold text-slate-800 text-lg group-hover:text-indigo-600 transition-colors"><?php echo e($item['label']); ?></h4>
                        <p class="text-xs text-slate-500 font-medium">Akses halaman <?php echo e(strtolower($item['label'])); ?></p>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="pt-4 border-t border-indigo-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="w-full py-4 rounded-xl bg-slate-900 text-white font-bold text-center shadow-xl shadow-slate-900/20">
                        Buka Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="w-full py-4 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white font-bold text-center shadow-xl shadow-purple-500/30">
                        Login Sekarang
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\layouts\partials\public-header.blade.php ENDPATH**/ ?>