...
<template x-teleport="#main-content">
    ...
    >
        ...
        <button 
            @click="viewDetail(activeMenuClient.id); closeMenu()"
        ...
        <button 
            @click="openEditModal(activeMenuClient)"
        ...
        <button 
            ...
            @click="unblockClient(activeMenuClient.id); closeMenu()"
        ...
        <button 
            @click="deleteClient(activeMenuClient.id); closeMenu()"
            class="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors group"
        >
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\blocked-clients\partials\action-menu.blade.php ENDPATH**/ ?>