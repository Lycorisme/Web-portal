...
function profilePage() {
    return {
        ...
        async deleteAccount(data) {
            try {
                const response = await fetch('<?php echo e(route("public.profile.delete")); ?>', {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\profile\partials\profile-scripts.blade.php ENDPATH**/ ?>