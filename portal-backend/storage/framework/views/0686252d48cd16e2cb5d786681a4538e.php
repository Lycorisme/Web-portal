...
<header x-data="{ mobileMenuOpen: false, searchOpen: false, scrolled: false }"
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('public.home')); ?>" wire:navigate class="flex items-center gap-3 group">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteLogo)): ?>
                    <img src="<?php echo e(asset($siteLogo)); ?>" alt="<?php echo e($siteName); ?>" class="h-10 w-auto group-hover:scale-105 transition-transform duration-300">
            ...
            <?php app("livewire")->forceAssetInjection(); ?><div x-persist="<?php echo e('desktop-navigation'); ?>">
            <nav x-data="{
                ...
                isActive(route) {
                    if (route === '<?php echo e(parse_url(route('public.home'), PHP_URL_PATH)); ?>') {
                ...
                updateActive() {
                    this.$nextTick(() => {
                        ...
                        // Check each link
                         const homePath = '<?php echo e(parse_url(route('public.home'), PHP_URL_PATH)); ?>';
                         const articlesPath = '<?php echo e(parse_url(route('public.articles'), PHP_URL_PATH)); ?>';
                         const galleryPath = '<?php echo e(parse_url(route('public.gallery'), PHP_URL_PATH)); ?>';
            ...
            class="hidden lg:flex items-center gap-1 p-1 bg-slate-950/30 backdrop-blur-sm border border-white/5 rounded-full relative">
                ...
                <a href="<?php echo e(route('public.home')); ?>" wire:navigate 
                   class="px-5 py-2 rounded-full text-sm font-bold transition-colors duration-300 relative z-10"
                   :class="isActive('<?php echo e(parse_url(route('public.home'), PHP_URL_PATH)); ?>') ? 'text-emerald-400' : 'text-slate-400 hover:text-white'">
                   Beranda
                </a>
                <a href="<?php echo e(route('public.articles')); ?>" wire:navigate 
                   class="px-5 py-2 rounded-full text-sm font-bold transition-colors duration-300 relative z-10"
                   :class="isActive('<?php echo e(parse_url(route('public.articles'), PHP_URL_PATH)); ?>') ? 'text-emerald-400' : 'text-slate-400 hover:text-white'">
                   Berita
                </a>
                <a href="<?php echo e(route('public.gallery')); ?>" wire:navigate 
                   class="px-5 py-2 rounded-full text-sm font-bold transition-colors duration-300 relative z-10"
                   :class="isActive('<?php echo e(parse_url(route('public.gallery'), PHP_URL_PATH)); ?>') ? 'text-emerald-400' : 'text-slate-400 hover:text-white'">
                   Galeri
                </a>
            </nav>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex items-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canAccessDashboard()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white text-xs font-bold uppercase tracking-wider shadow-lg shadow-emerald-500/20 transition-all transform hover:-translate-y-0.5 border border-emerald-400/20">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <div class="relative" x-data="{ userMenuOpen: false }">
                                <button @click="userMenuOpen = !userMenuOpen" @click.outside="userMenuOpen = false" 
                                    ...
                                    <div class="text-right hidden xl:block pr-2">
                                        <span class="block text-sm font-bold text-slate-200 group-hover:text-white transition-colors leading-tight"><?php echo e(auth()->user()->name); ?></span>
                                        <span class="block text-[10px] font-medium text-emerald-500 uppercase tracking-wider leading-tight">Member Area</span>
                                    </div>

                                    <div class="relative">
                                         <?php if(auth()->user()->profile_photo): ?>
                                             <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-10 h-10 rounded-full object-cover ring-2 ring-slate-800 group-hover:ring-emerald-500/50 transition-all">
                                         <?php else: ?>
                                ...
                                <div x-show="userMenuOpen" 
                                     ...
                                     <div class="p-4 rounded-2xl bg-white/5 border border-white/5 mb-2 flex items-center gap-4 relative overflow-hidden group/card">
                                         ...
                                         <?php if(auth()->user()->profile_photo): ?>
                                             <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-14 h-14 rounded-full object-cover border-2 border-white/10 group-hover/card:border-emerald-500/50 transition-colors shadow-lg relative z-10 box-content">
                                         <?php else: ?>
                                         ...
                                         <div class="flex-1 min-w-0 relative z-10">
                                             <h4 class="text-white font-bold truncate text-base group-hover/card:text-emerald-400 transition-colors leading-tight"><?php echo e(auth()->user()->name); ?></h4>
                                             <p class="text-slate-400 text-xs truncate mt-0.5"><?php echo e(auth()->user()->email); ?></p>
                                             <a href="<?php echo e(route('public.profile.index')); ?>" wire:navigate class="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-500 mt-1.5 hover:text-emerald-400 transition-colors uppercase tracking-wider bg-emerald-500/10 hover:bg-emerald-500/20 px-2 py-0.5 rounded-full">
                                     ...
                                     <div class="space-y-1">
                                         ...
                                         <a href="<?php echo e(route('public.profile.index')); ?>?tab=activity" wire:navigate class="group flex items-center gap-4 px-4 py-3 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-2xl transition-all">
                                         ...
                                         <a href="<?php echo e(route('public.profile.index')); ?>?tab=settings" wire:navigate class="group flex items-center gap-4 px-4 py-3 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-2xl transition-all">
                                     ...
                                     <form method="POST" action="<?php echo e(route('logout')); ?>" class="p-1">
                                         <?php echo csrf_field(); ?>
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="group relative px-6 py-2.5 rounded-xl overflow-hidden bg-slate-800 border border-slate-700 text-slate-300 font-bold text-xs uppercase tracking-wider hover:text-white hover:border-slate-500 transition-all">
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="flex flex-col items-center w-full max-w-sm px-6 h-full overflow-y-auto py-24 hide-scrollbar">
                ...
                <div class="mb-8"
                     ...
                     x-transition:enter-end="opacity-100 translate-y-0 scale-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteLogo)): ?>
                        <img src="<?php echo e(asset($siteLogo)); ?>" alt="<?php echo e($siteName); ?>" class="h-20 w-auto">
                    <?php else: ?>
                         <span class="text-4xl font-bold font-display text-white"><?php echo e($siteName); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <div class="space-y-6 flex flex-col items-center w-full">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                        ...
                        <a href="<?php echo e(route($item['route'])); ?>" wire:navigate 
                           class="text-4xl font-display font-bold transition-all tracking-tight <?php echo e(request()->routeIs($item['route'].'*') ? 'text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 scale-105' : 'text-slate-400 hover:text-white hover:scale-105'); ?>"
                           x-show="mobileMenuOpen"
                           x-transition:enter="transition ease-out duration-500"
                           x-transition:enter-start="opacity-0 translate-y-8"
                           x-transition:enter-end="opacity-100 translate-y-0"
                           style="transition-delay: <?php echo e(($index + 2) * 100); ?>ms">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                         <div class="flex flex-col items-center gap-4 w-full">
                            <div class="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 w-full relative overflow-hidden group">
                                ...
                                <?php if(auth()->user()->profile_photo): ?>
                                    <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-14 h-14 rounded-full object-cover border-2 border-white/10 shadow-lg relative z-10">
                                <?php else: ?>
                                ...
                                <div class="text-left flex-1 min-w-0 relative z-10">
                                    <div class="font-bold text-white text-lg truncate"><?php echo e(auth()->user()->name); ?></div>
                             ...
                             <div class="w-full grid grid-cols-2 gap-3">
                                 <a href="<?php echo e(route('public.profile.index')); ?>?tab=activity" wire:navigate class="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-800/50 border border-white/5 hover:bg-slate-800 hover:border-pink-500/30 transition-all group">
                                 ...
                                 <a href="<?php echo e(route('public.profile.index')); ?>?tab=activity" wire:navigate class="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-800/50 border border-white/5 hover:bg-slate-800 hover:border-blue-500/30 transition-all group">
                                     <div class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                 ...
                                 <a href="<?php echo e(route('public.profile.index')); ?>" wire:navigate class="col-span-2 flex items-center gap-4 px-4 py-3 rounded-2xl bg-slate-800/50 border border-white/5 hover:bg-slate-800 hover:border-amber-500/30 transition-all group">
                             ...
                             <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canAccessDashboard()): ?>
                                <a href="<?php echo e(route('dashboard')); ?>" wire:navigate class="w-full py-4 bg-emerald-600 hover:bg-emerald-500 rounded-2xl text-center text-white font-bold uppercase tracking-widest text-sm shadow-xl shadow-emerald-600/20 transition-all hover:scale-[1.02] active:scale-[0.98] mt-2">
                                    Dashboard
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <template x-teleport="body">
        <div x-show="searchOpen"
            ...
            <div class="w-full max-w-3xl text-center relative z-10">
                ...
                <form action="<?php echo e(route('public.articles')); ?>" method="GET" class="relative group"
                      x-show="searchOpen"
                ...
                <div class="mt-12 flex flex-wrap justify-center gap-3"
                    ...
                    <a href="<?php echo e(route('public.articles', ['tag' => 'teknologi'])); ?>" wire:navigate class="text-sm font-bold text-emerald-400 hover:text-emerald-300 transition-colors underline decoration-emerald-500/30 font-display">Teknologi</a>
                    <a href="<?php echo e(route('public.articles', ['tag' => 'pendidikan'])); ?>" wire:navigate class="text-sm font-bold text-emerald-400 hover:text-emerald-300 transition-colors underline decoration-emerald-500/30 font-display">Pendidikan</a>
                    <a href="<?php echo e(route('public.articles', ['tag' => 'digital'])); ?>" wire:navigate class="text-sm font-bold text-emerald-400 hover:text-emerald-300 transition-colors underline decoration-emerald-500/30 font-display">Digital</a>
                </div>
            </div>
        </div>
    </template>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\layouts\partials\public-header.blade.php ENDPATH**/ ?>