        ...
        return {
            ...
            async submitVerify() {
                ...
                try { // Using existing route logic which redirects, we might need to change it or handle redirect manually?
                      ...
                      form.method = 'POST';
                      form.action = '<?php echo e(route("verification.verify")); ?>';
            ...
            async sendOtp() {
                ...
                this.successMessage = '';
                try {
                    const response = await fetch('<?php echo e(route("password.send-otp")); ?>', {
                        method: 'POST',
            ...
            async verifyOtp() {
                ...
                this.successMessage = '';
                try {
                    const response = await fetch('<?php echo e(route("password.verify-otp")); ?>', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
            ...
            async resetPassword() {
                ...
                this.successMessage = '';
                try {
                    const response = await fetch('<?php echo e(route("password.reset")); ?>', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\auth\partials\login-scripts.blade.php ENDPATH**/ ?>