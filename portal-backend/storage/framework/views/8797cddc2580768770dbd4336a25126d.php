...
async openEditModal(item) {
    ...
    if (isGroup && item.group_item_ids) {
        ...
        try {
            ...
            const response = await fetch(`<?php echo e(route('galleries.album-items')); ?>?${params}`);
...
async submitForm() {
    ...
    try {
        ...
        if (this.formMode === 'create' && this.formData.media_type === 'image' && this.imageFiles.length > 1) {
            ...
            url = '<?php echo e(route("galleries.bulk-store")); ?>';
            ...
            url = (this.formMode === 'create') ? '<?php echo e(route("galleries.store")); ?>' : `/galleries/${this.formData.id}`;
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\galleries\partials\scripts\form.blade.php ENDPATH**/ ?>