...
function userApp() {
    return {
        ...
        // FORM MODULE
        // ========================================
        <?php echo $__env->make('users.partials.scripts.form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // CRUD MODULE
        // ========================================
        <?php echo $__env->make('users.partials.scripts.crud', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // BULK ACTIONS MODULE
        // ========================================
        <?php echo $__env->make('users.partials.scripts.bulk-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // HELPERS MODULE
        // ========================================
        <?php echo $__env->make('users.partials.scripts.helpers', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        async fetchUsers() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('users.data')); ?>?${params}`);
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\users\partials\scripts.blade.php ENDPATH**/ ?>