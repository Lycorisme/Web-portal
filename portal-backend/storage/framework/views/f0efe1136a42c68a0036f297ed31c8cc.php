        ...
        <div class="space-y-4 sm:space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
                ...
                <input type="number" name="rate_limit_per_minute" id="rate_limit_per_minute"
                    value="<?php echo e($rawSettings['rate_limit_per_minute'] ?? 60); ?>"
                    min="10" max="1000"
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="auto_ban_enabled" class="sr-only peer" <?php echo e(($rawSettings['auto_ban_enabled'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="flex items-center justify-between p-4 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="maintenance_mode" class="sr-only peer" <?php echo e(($rawSettings['maintenance_mode'] ?? false) ? 'checked' : ''); ?>>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\settings\partials\security.blade.php ENDPATH**/ ?>