<?php $__env->startSection('meta_title', 'Berita'); ?>
        ...
        <div class="text-center mb-16 relative z-10">
            ...
            <h1 class="mt-8 text-4xl md:text-6xl lg:text-7xl font-display font-bold text-white leading-tight tracking-tight">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('kategori')): ?>
                    Kategori <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400"><?php echo e(ucwords(str_replace('-', ' ', request('kategori')))); ?></span>
                <?php elseif(request('tag')): ?>
                    Tag <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400"><?php echo e(ucwords(str_replace('-', ' ', request('tag')))); ?></span>
                <?php elseif(request('q')): ?>
                    Hasil <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">"<?php echo e(request('q')); ?>"</span>
                <?php else: ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12 relative z-10">
            ...
            <div class="order-2 lg:order-1 lg:col-span-1 space-y-6 lg:space-y-8">
                ...
                <div class="bg-slate-900/50 rounded-[32px] border border-white/5 p-6 backdrop-blur-sm shadow-xl">
                    ...
                    <form action="<?php echo e(route('public.articles')); ?>" method="GET">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('kategori')): ?>
                            <input type="hidden" name="kategori" value="<?php echo e(request('kategori')); ?>">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="relative group">
                            <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Kata kunci..." class="w-full pl-10 pr-4 py-3.5 bg-slate-950/50 border border-white/10 rounded-2xl text-slate-200 text-sm font-bold focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all placeholder-slate-600 group-hover:bg-slate-950/80">
                ...
                <div class="bg-slate-900/50 rounded-[32px] border border-white/5 p-6 backdrop-blur-sm shadow-xl">
                    ...
                    <div class="flex flex-col space-y-2">
                        <a href="<?php echo e(route('public.articles')); ?>" wire:navigate class="flex justify-between items-center px-4 py-3.5 rounded-2xl transition-all <?php echo e(!request('kategori') ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white border border-transparent hover:border-white/5'); ?>">
                            <span class="text-xs font-bold uppercase tracking-wide">Semua Berita</span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!request('kategori')): ?> <i class="fas fa-check text-[10px]"></i> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('public.articles', ['kategori' => $category->slug])); ?>" wire:navigate class="flex justify-between items-center px-4 py-3.5 rounded-2xl transition-all <?php echo e(request('kategori') == $category->slug ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white border border-transparent hover:border-white/5'); ?>">
                                <span class="text-xs font-bold uppercase tracking-wide"><?php echo e($category->name); ?></span>
                                <span class="text-[10px] <?php echo e(request('kategori') == $category->slug ? 'bg-emerald-500/20 text-emerald-300' : 'bg-slate-800 text-slate-400'); ?> px-2 py-0.5 rounded-md font-black min-w-[24px] text-center"><?php echo e($category->articles_count); ?></span>
                            </a>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($articles->count() > 0): ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4 md:gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <article class="<?php echo e($colClass); ?> <?php echo e($heightClass); ?> group relative rounded-[32px] overflow-hidden border border-white/5 bg-slate-900 shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:-translate-y-2 hover:border-emerald-500/30">
                                <!-- Background Image -->
                                <div class="absolute inset-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->image_url): ?>
                                        <img src="<?php echo e($article->image_url); ?>" alt="<?php echo e($article->title); ?>" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                                    <?php else: ?>
                                    ...
                                    <div class="transform transition-transform duration-500 translate-y-4 group-hover:translate-y-0">
                                        ...
                                        <div class="flex items-center gap-3 mb-3 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 delay-100">
                                            <span class="px-3 py-1 bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded-full text-[10px] font-black uppercase tracking-widest backdrop-blur-md">
                                                <?php echo e($article->categoryRelation?->name ?? 'News'); ?>

                                            </span>
                                            <span class="text-[10px] text-slate-300 font-bold uppercase tracking-widest hidden sm:inline flex items-center gap-1">
                                                <i class="far fa-calendar-alt"></i> <?php echo e($article->published_at ? \Carbon\Carbon::parse($article->published_at)->format('d M Y') : ''); ?>

                                            </span>
                                        </div>

                                        <!-- Title -->
                                        <h2 class="<?php echo e($titleSize); ?> font-extrabold text-white leading-tight mb-3 group-hover:text-emerald-400 transition-colors">
                                            <a href="<?php echo e(route('public.article.show', $article->slug)); ?>" wire:navigate class="focus:outline-none">
                                        ...
                                        <!-- Excerpt (Conditional) -->
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showExcerpt): ?>
                ...
                <?php else: ?>
                    <div class="text-center py-20 bg-slate-900/30 rounded-[40px] border border-dashed border-slate-800 backdrop-blur-sm relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <a href="<?php echo e(route('public.articles')); ?>" wire:navigate class="inline-flex items-center px-8 py-3 rounded-xl bg-slate-800 text-white font-bold uppercase tracking-widest text-xs hover:bg-emerald-600 transition-all shadow-lg hover:shadow-emerald-500/25 border border-white/5 hover:border-emerald-500/50">
                                Reset Filter
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('public.layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\articles.blade.php ENDPATH**/ ?>