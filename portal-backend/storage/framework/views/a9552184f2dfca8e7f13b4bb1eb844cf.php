<?php $__env->startSection('meta_title', $article->title); ?>
<?php $__env->startSection('meta_description', $article->excerpt ?? Str::limit(strip_tags($article->content), 160)); ?>
...
<div class="w-full max-w-full overflow-x-hidden bg-[#020617] min-h-screen">
    ...
    <?php echo $__env->make('public.article.partials.hero-section', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                <article class="flex-1 min-w-0">
                    ...
                    <div class="bg-slate-900/80 backdrop-blur-md rounded-[32px] sm:rounded-[40px] border border-white/5 p-6 sm:p-10 lg:p-12 shadow-2xl relative overflow-hidden mb-8">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->tags && $article->tags->count() > 0): ?>
                        ...
                        <div class="mt-8 pt-6 border-t border-white/5">
                            <?php echo $__env->make('public.article.partials.engagement-bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                    
                    
                    <?php echo $__env->make('public.article.partials.comments-section', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                </article>

                
                <div class="w-full lg:w-[22rem] flex-shrink-0 space-y-8">
                     <?php echo $__env->make('public.article.partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
...
<?php echo $__env->make('public.layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\article-detail.blade.php ENDPATH**/ ?>