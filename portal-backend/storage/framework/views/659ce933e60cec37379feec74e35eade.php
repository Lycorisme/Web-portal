            ...
            <div class="relative" x-data="{ open: false }">
                    ...
                    <div class="w-9 h-9 rounded-lg overflow-hidden flex items-center justify-center shadow-theme">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser?->avatar): ?>
                            <img id="headerProfilePhoto" 
                                 src="<?php echo e($currentUser->avatar); ?>" 
                        ...
                        <?php else: ?>
                            <div id="headerProfileInitials" class="w-full h-full bg-theme-gradient flex items-center justify-center rounded-lg">
                                <span class="text-white font-semibold text-sm"><?php echo e(strtoupper(substr($currentUser?->name ?? 'AD', 0, 2))); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="hidden sm:block text-left">
                        <p class="text-sm font-semibold text-surface-900 dark:text-white"><?php echo e($currentUser?->name ?? 'Admin'); ?></p>
                        <p class="text-xs text-surface-500"><?php echo e($currentUser?->role ?? 'Administrator'); ?></p>
                    </div>
                ...
                <div x-show="open" @click.away="open = false"
                    ...
                    <div class="p-4 border-b border-surface-200 dark:border-surface-800">
                        <p class="font-semibold text-surface-900 dark:text-white"><?php echo e($currentUser?->name ?? 'Admin'); ?></p>
                        <p class="text-sm text-surface-500"><?php echo e($currentUser?->email ?? 'admin@portal.id'); ?></p>
                    </div>
                    <div class="p-2">
                        ...
                        <a href="<?php echo e(route('public.home')); ?>" target="_blank"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views/partials/header.blade.php ENDPATH**/ ?>