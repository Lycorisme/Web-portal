...
<div class="p-4 sm:p-6 pb-10 mb-0 border-b border-surface-200/50 dark:border-surface-800/50">
    ...
    <div class="flex flex-row items-center gap-4 mb-4">
        ...
        >
            ...
            <span class="hidden sm:inline">Blokir IP</span>
        </button>
    </div>
    ...
    <div class="flex flex-col lg:flex-row lg:items-end gap-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 flex-1">
            ...
            <div>
                <label class="block text-xs font-medium text-surface-500 dark:text-surface-400 mb-1.5">Urutan</label>
                <select 
        ...
        <div class="flex items-center gap-2 flex-shrink-0 w-full lg:w-auto">
            ...
            <button 
                @click="clearExpired()"
                class="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl font-medium text-sm transition-all border shadow-sm bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/20 hover:bg-amber-100 dark:hover:bg-amber-500/20"
                title="Bersihkan Expired"
            >
                <i data-lucide="clock" class="w-4 h-4"></i>
                <span class="hidden sm:inline">Bersihkan Expired</span>
            </button>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\blocked-clients\partials\filter.blade.php ENDPATH**/ ?>