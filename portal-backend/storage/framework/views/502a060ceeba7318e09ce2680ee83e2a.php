...
<head>
    ...
    <title>Under Maintenance - <?php echo e($siteName ?? 'Portal'); ?></title>
    
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($faviconUrl ?? false): ?>
...
<body class="bg-slate-950 text-slate-200 min-h-screen flex items-center justify-center overflow-hidden relative antialiased selection:bg-emerald-500/30 selection:text-emerald-400">
    ...
    <div class="relative z-10 w-full max-w-xl px-4 text-center">
        ...
        <div class="mb-10 flex justify-center animate-float">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoUrl ?? false): ?>
            ...
            <?php else: ?>
                ...
                <div class="flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-xl shadow-emerald-500/5">
                   <div class="w-8 h-8 rounded-lg bg-emerald-500 flex items-center justify-center text-white font-bold font-display text-lg shadow-lg shadow-emerald-500/30">
                       <?php echo e(substr($siteName ?? 'P', 0, 1)); ?>

                   </div>
                   <span class="text-lg font-bold font-display tracking-tight text-white/90"><?php echo e($siteName ?? 'PORTAL'); ?></span>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($contactEmail ?? false): ?>
            <a href="mailto:<?php echo e($contactEmail); ?>" class="w-full sm:w-auto px-8 py-3 bg-white/5 border border-white/10 text-slate-300 font-medium font-display rounded-xl hover:bg-white/10 hover:text-white transition-colors flex items-center justify-center gap-2">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\maintenance.blade.php ENDPATH**/ ?>