<div class="relative overflow-hidden rounded-2xl bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-800 p-6 shadow-xl shadow-theme-500/5 group">
    ...
    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex-1 text-center md:text-left">
            ...
            <p class="text-sm text-surface-500 dark:text-surface-400 font-medium max-w-xl mx-auto md:mx-0">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['is_author']): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['pending_articles'] > 0): ?>
                        Anda memiliki <span class="text-amber-600 dark:text-amber-400 font-semibold"><?php echo e($stats['pending_articles']); ?> artikel</span> yang menunggu persetujuan editor.
                    <?php elseif($stats['draft_articles'] > 0): ?>
                        Anda memiliki <span class="text-blue-600 dark:text-blue-400 font-semibold"><?php echo e($stats['draft_articles']); ?> draft</span> yang perlu diselesaikan.
                    <?php else: ?>
                ...
                <?php elseif($stats['is_editor']): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['pending_articles'] > 0): ?>
                        Ada <span class="text-amber-600 dark:text-amber-400 font-semibold"><?php echo e($stats['pending_articles']); ?> artikel</span> yang perlu Anda review dari para kontributor.
                    <?php else: ?>
                ...
                <?php else: ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['pending_articles'] > 0): ?>
                        Ada <span class="text-surface-900 dark:text-white font-semibold"><?php echo e($stats['pending_articles']); ?> artikel pending</span> menunggu review tim.
                    <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['is_author'] && $stats['draft_articles'] > 0): ?>
            <div class="flex items-center justify-center md:justify-start gap-3 mt-5">
                <a href="<?php echo e(route('articles')); ?>" class="px-5 py-2.5 bg-surface-900 dark:bg-surface-800 text-white border border-surface-700 rounded-lg text-sm font-semibold hover:bg-surface-800 dark:hover:bg-surface-700 transition-colors flex items-center gap-2">
                    <i data-lucide="file-edit" class="w-4 h-4 text-theme-400"></i>
                    <span>Lanjutkan Draft</span>
                </a>
            </div>
            <?php elseif(($stats['is_editor'] || $stats['is_admin']) && $stats['pending_articles'] > 0): ?>
            <div class="flex items-center justify-center md:justify-start gap-3 mt-5">
                <a href="<?php echo e(route('articles')); ?>?status=pending" class="px-5 py-2.5 bg-surface-900 dark:bg-surface-800 text-white border border-surface-700 rounded-lg text-sm font-semibold hover:bg-surface-800 dark:hover:bg-surface-700 transition-colors flex items-center gap-2">
        ...
        <div class="hidden md:flex items-center gap-4 px-5 py-2.5 bg-white/50 dark:bg-surface-800/50 backdrop-blur-md border border-surface-200/60 dark:border-surface-700/60 rounded-2xl shadow-lg shadow-surface-200/10 dark:shadow-surface-900/10 hover:shadow-xl hover:scale-[1.02] hover:bg-white dark:hover:bg-surface-800 hover:border-theme-500/20 dark:hover:border-theme-500/20 transition-all duration-300 group/clock"
             x-data="{
                serverOffset: <?php echo e(now()->timestamp * 1000); ?> - Date.now(),
                hours: '00',
                minutes: '00',
                seconds: '00',
                dayName: '',
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\dashboard\partials\welcome-banner.blade.php ENDPATH**/ ?>