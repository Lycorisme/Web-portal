...
<div class="min-h-screen flex items-center justify-center bg-slate-900 p-4">
    <div class="max-w-md w-full text-center">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($reason) && $reason): ?>
        <div class="bg-slate-800/50 rounded-xl p-4 mb-6 border border-slate-700">
            <p class="text-sm text-slate-300">
                <span class="font-semibold text-amber-400">Alasan:</span> <?php echo e($reason); ?>

            </p>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($blocked_until) && $blocked_until): ?>
        <div class="bg-slate-800/50 rounded-xl p-4 mb-6 border border-slate-700">
            <p class="text-sm text-slate-300">
                <span class="font-semibold text-amber-400">Blokir berakhir:</span> 
                <?php echo e($blocked_until->format('d M Y, H:i')); ?> WIB
            </p>
            <p class="text-xs text-slate-500 mt-2">
                (<?php echo e($blocked_until->diffForHumans()); ?>)
            </p>
        </div>
        <?php else: ?>
        <div class="bg-slate-800/50 rounded-xl p-4 mb-6 border border-slate-700">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\errors\blocked.blade.php ENDPATH**/ ?>