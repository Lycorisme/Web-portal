            ...
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <nav class="flex items-center gap-2 text-sm font-medium text-surface-500 dark:text-surface-400">
                        <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-theme-600 transition-colors flex items-center gap-1.5">
    ...
    <div x-data="profilePage()" class="animate-slide-up" style="animation-delay: 0.1s;">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-4 space-y-4 sm:space-y-6">
                ...
                <?php echo $__env->make('profile.partials.photo-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                
                
                <?php echo $__env->make('profile.partials.stats-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>

            
            <div class="lg:col-span-8 space-y-4 sm:space-y-6">
                
                <?php echo $__env->make('profile.partials.info-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                
                
                <?php echo $__env->make('profile.partials.security-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                
                
                <?php echo $__env->make('profile.partials.activity-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>

        
        <?php echo $__env->make('profile.partials.bulk-action-bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<style>
    /* Cropper.js Custom Styles for Profile */
    .cropper-container {
        border-radius: 1rem;
        overflow: hidden;
    }
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.1/cropper.min.js"></script>
    <?php echo $__env->make('profile.partials.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>


<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\profile\index.blade.php ENDPATH**/ ?>