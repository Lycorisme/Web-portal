    ...
    <div class="email-wrapper">
        ...
        <div class="header">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($logoDataUrl)): ?>
                <img src="<?php echo e($logoDataUrl); ?>" alt="<?php echo e($siteName); ?>" style="max-height: 60px; width: auto; margin-bottom: 10px;">
            <?php else: ?>
                ...
                <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #0d9488 0%, #14b8a6 100%); border-radius: 12px; display: inline-block; line-height: 60px; text-align: center; margin-bottom: 10px;">
                    <span style="color: white; font-size: 24px; font-weight: bold;"><?php echo e(substr($siteName, 0, 1)); ?></span>
                </div>
        ...
        <!-- Content -->
        <div class="content">
            <p class="greeting">Halo, <strong><?php echo e($userName); ?></strong></p>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'password_reset'): ?>
                <p class="message">
                    Kami menerima permintaan untuk mereset password akun Anda. 
                    Gunakan kode OTP di bawah ini untuk melanjutkan proses reset password.
                </p>
            <?php elseif($type === 'login_2fa'): ?>
                <p class="message">
            ...
            <div class="otp-container">
                ...
                <p class="otp-code"><?php echo e($otpCode); ?></p>
                <p class="otp-expiry">
                    ⏱️ Kode berlaku selama <strong><?php echo e($expiryMinutes); ?> menit</strong>
                </p>
            </div>
            ...
            <div class="info-box">
                <p>
                    ...
                    dari <?php echo e($siteName); ?>. Kami tidak pernah meminta kode OTP melalui telepon atau chat.
                </p>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p>Email ini dikirim secara otomatis oleh sistem <?php echo e($siteName); ?>.</p>
            <p>© <?php echo e(date('Y')); ?> <?php echo e($siteName); ?>. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\emails\otp-verification.blade.php ENDPATH**/ ?>