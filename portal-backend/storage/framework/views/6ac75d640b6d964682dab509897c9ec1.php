...
function articleApp() {
    return {
        ...
        // SECURITY MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.security', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // FORM MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // CROPPER MODULE (Image Cropping)
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.cropper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // CRUD MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.crud', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // BULK ACTIONS MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.bulk-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // COMMENTS MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.comments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // STATISTICS MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.statistics', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // HELPERS MODULE
        // ========================================
        <?php echo $__env->make('articles.partials.scripts.helpers', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        async fetchTags() {
            try {
                const response = await fetch(`<?php echo e(route('tags.data')); ?>?per_page=100&is_active=1`);
        ...
        async fetchArticles() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('articles.data')); ?>?${params}`);
                const result = await response.json();
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\articles\partials\scripts.blade.php ENDPATH**/ ?>