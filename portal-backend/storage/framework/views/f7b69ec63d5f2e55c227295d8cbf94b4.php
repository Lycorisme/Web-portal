...
<div class="mt-6 sm:mt-8 p-4 sm:p-5 bg-slate-950/50 rounded-[24px] border border-white/5 flex flex-wrap items-center justify-between gap-4 backdrop-blur-sm">
    <div class="flex items-center gap-3 sm:gap-4">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <div x-data="{ liked: <?php echo e($hasLiked ? 'true' : 'false'); ?>, count: <?php echo e($article->likes_count ?? 0); ?> }">
                <form action="<?php echo e(route('public.article.like', $article->id)); ?>" method="POST"
                      @submit.prevent="liked = !liked; count = liked ? count + 1 : count - 1; fetch($el.action, { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } })">
                ...
                <div x-show="showLoginToast" 
                     ...
                     <div class="flex items-start gap-3">
                         ...
                         <div>
                            ...
                            <p class="text-slate-400 leading-relaxed">Silakan <a href="<?php echo e(route('login')); ?>" class="text-emerald-400 font-bold hover:underline decoration-emerald-500/30">Login</a> terlebih dahulu untuk menyukai berita ini.</p>
                        </div>
                     </div>
        ...
        <a href="#comments" class="flex items-center gap-2 group">
            ...
            <span class="font-bold text-slate-300 text-sm"><?php echo e($article->visibleComments->count()); ?></span>
        </a>
    </div>
    ...
    <div x-data="{ 
        ...
        articleTitle: `<?php echo e(addslashes($article->title)); ?>`,
        copyLink() {
        ...
        <div x-show="showShare" 
            ...
            <div class="p-4 border-b border-slate-800/50">
                ...
                <p class="text-slate-500 text-xs mt-1 line-clamp-1"><?php echo e($article->title); ?></p>
            </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\article\partials\engagement-bar.blade.php ENDPATH**/ ?>