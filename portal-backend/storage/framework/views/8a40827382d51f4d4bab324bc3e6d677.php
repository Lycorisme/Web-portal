            ...
            <div class="flex items-center justify-between w-full sm:w-auto gap-3">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-theme-600 dark:text-theme-400 font-semibold text-sm whitespace-nowrap">
                        <span x-text="selectedIds.length"></span> user dipilih
                    </span>
                </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\users\partials\bulk-action-bar.blade.php ENDPATH**/ ?>