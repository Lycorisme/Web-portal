...
<div x-show="mode === 'login'"
    ...
    <?php echo $__env->make('auth.partials.lockout-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-6">
        ...
        <div class="space-y-2">
            ...
            <input type="email" 
                   ...
                   autofocus
                   :disabled="isLocked"
                   class="w-full px-5 py-4 rounded-xl modern-input text-white placeholder-slate-500 text-sm font-medium <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?> disabled:opacity-50 disabled:cursor-not-allowed" 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="space-y-2">
            ...
            <input type="password" 
                   ...
                   required
                   :disabled="isLocked"
                   class="w-full px-5 py-4 rounded-xl modern-input text-white placeholder-slate-500 text-sm font-medium tracking-widest <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex items-center justify-between pt-2">
            <label class="flex items-center gap-3 cursor-pointer group" for="remember" x-data="{ checked: <?php echo e(old('remember') ? 'true' : 'false'); ?> }">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\auth\partials\login-form.blade.php ENDPATH**/ ?>