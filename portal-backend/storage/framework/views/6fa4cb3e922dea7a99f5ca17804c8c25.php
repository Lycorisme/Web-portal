...
<div class="p-4 sm:p-6 pb-10 mb-0 border-b border-surface-200/50 dark:border-surface-800/50">
    ...
    <div class="flex flex-row items-center gap-4 mb-4">
        ...
        >
            ...
            <span class="hidden sm:inline">Tambah Galeri</span>
        </button>
    </div>
    ...
    <div class="flex flex-col lg:flex-row lg:items-end gap-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 flex-1">
            ...
            <div>
                <label class="block text-xs font-medium text-surface-500 dark:text-surface-400 mb-1.5">Tipe Media</label>
                <select 
                    x-model="filters.media_type"
            ...
            <div>
                <label class="block text-xs font-medium text-surface-500 dark:text-surface-400 mb-1.5">Album</label>
                <select 
                    x-model="filters.album"
                    class="w-full px-3 py-2.5 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl text-sm text-surface-900 dark:text-white focus:ring-2 focus:ring-theme-500 focus:border-transparent transition-all"
                >
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $albums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($album); ?>"><?php echo e($album); ?></option>
            ...
            <div>
                <label class="block text-xs font-medium text-surface-500 dark:text-surface-400 mb-1.5">Featured</label>
                <select 
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\galleries\partials\filter.blade.php ENDPATH**/ ?>