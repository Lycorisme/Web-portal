    ...
    <div class="flex flex-col lg:flex-row lg:items-end gap-4">
        ...
        <div class="grid grid-cols-2 gap-3 flex-1">
            ...
            <div>
                ...
                <select 
                    x-model="filters.article_status"
            ...
            <div>
                <label class="block text-xs font-medium text-surface-500 dark:text-surface-400 mb-1.5">Kategori</label>
                <select 
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\articles\partials\filter.blade.php ENDPATH**/ ?>