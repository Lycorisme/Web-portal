        ...
        <div class="grid grid-cols-3 gap-2 sm:gap-3 flex-1">
            ...
            <div>
                ...
                >
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\activity-log\partials\filter.blade.php ENDPATH**/ ?>