<?php $__env->startSection('meta_title', 'Beranda'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <header class="max-w-7xl mx-auto px-6 pt-32">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[500px]">
            ...
            <div x-data='{ 
                    activeSlide: 0,
                    slides: <?php echo $featuredArticles->map(fn($a) => [
                        "img" => $a->image_url,
                        "title" => $a->title,
            ...
            <div class="lg:col-span-4 flex flex-col gap-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sideArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('public.article.show', $article->slug)); ?>" wire:navigate class="block flex-1 relative group overflow-hidden rounded-[32px] border border-slate-800 hover:border-emerald-500/30 transition-colors">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->image_url): ?>
                            <img src="<?php echo e($article->image_url); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                        <?php else: ?>
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 to-transparent p-6 flex flex-col justify-end">
                            ...
                            <p class="text-[10px] text-emerald-500 font-black mt-2 tracking-widest uppercase">
                                <?php echo e($article->categoryRelation?->name ?? 'Update'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < (2 - $sideArticles->count()); $i++): ?>
    ...
    <main class="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-8 space-y-12"
            x-data='{
                activeCategory: "all",
                isLoading: false,
                categories: <?php echo json_encode($categories->map(fn($c) => ["name" => $c->name, "slug" => $c->slug])); ?>,
                articles: <?php echo json_encode($latestArticles->slice(2)->map(fn($a) => [
                    "id" => $a->id,
                    "title" => $a->title,
                    "slug" => $a->slug,
                ...
                async fetchArticles(categorySlug) {
                    ...
                    try {
                        const response = await fetch(`<?php echo e(route("public.api.articles-by-category")); ?>?category=${categorySlug}`);
        ...
        >
            ...
            <div class="flex justify-center pt-10 w-full clear-both block">
                <a href="<?php echo e(route('public.articles')); ?>" wire:navigate class="px-12 py-4 rounded-2xl bg-slate-900 border border-slate-800 text-white font-bold hover:bg-emerald-600 transition-all shadow-xl uppercase text-xs tracking-widest">
                    Muat Berita Lainnya
                </a>
            </div>
        </div>
        ...
        <div class="lg:col-span-4 space-y-12">
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $popularArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('public.article.show', $article->slug)); ?>" wire:navigate class="flex gap-4 group">
                            <div class="w-20 h-20 rounded-2xl overflow-hidden shrink-0 border border-slate-800">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->image_url): ?>
                                    <img src="<?php echo e($article->image_url); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition duration-500">
                                <?php else: ?>
                            ...
                            <div>
                                ...
                                <span class="text-[10px] font-black text-rose-500 mt-2 flex items-center gap-1.5 uppercase">
                                    ...
                                    <?php echo e($article->likes_count ?? 0); ?> Likes
                                </span>
                            </div>
                        </a>
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($popularTags)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $popularTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('public.articles', ['tag' => $tag->slug])); ?>" wire:navigate class="px-4 py-2 bg-slate-900 border border-slate-800 rounded-xl text-[10px] font-black text-slate-400 hover:text-white hover:border-emerald-500 transition-all cursor-pointer uppercase">
                                #<?php echo e($tag->name); ?>
...
<?php echo $__env->make('public.layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\index.blade.php ENDPATH**/ ?>