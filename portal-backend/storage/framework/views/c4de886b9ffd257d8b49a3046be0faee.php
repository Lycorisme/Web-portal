...
function blockedClientApp() {
    return {
        ...
        // CRUD MODULE
        // ========================================
        <?php echo $__env->make('blocked-clients.partials.scripts.crud', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // BULK ACTIONS MODULE
        // ========================================
        <?php echo $__env->make('blocked-clients.partials.scripts.bulk-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        // ========================================
        // HELPERS MODULE
        // ========================================
        <?php echo $__env->make('blocked-clients.partials.scripts.helpers', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        async fetchClients() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('blocked-clients.data')); ?>?${params}`);
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\blocked-clients\partials\scripts.blade.php ENDPATH**/ ?>