...
async submitForm() {
    ...
    try {
        const url = this.formMode === 'create' ? '<?php echo e(route("tags.store")); ?>' : `/tags/${this.formData.id}`;
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\tags\partials\scripts\form.blade.php ENDPATH**/ ?>