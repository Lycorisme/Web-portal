...
async submitForm() {
    ...
    try {
        const url = this.formMode === 'create' ? '<?php echo e(route("users.store")); ?>' : `/users/${this.formData.id}`;
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\users\partials\scripts\form.blade.php ENDPATH**/ ?>