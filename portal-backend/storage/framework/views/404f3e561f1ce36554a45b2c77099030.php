<?php $__env->startSection('meta_title', 'Galeri'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="relative pt-32 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
        ...
        <div x-data="{ 
                lightboxOpen: false, 
                activeIndex: 0, 
                items: <?php echo e(Js::from($galleryItems)); ?>,
                touchStartX: 0,
                touchEndX: 0,
            ...
            <div class="mb-16 flex flex-wrap justify-center gap-4 relative z-10">
                <div class="p-1.5 rounded-2xl bg-slate-900/50 backdrop-blur-md border border-white/5 flex flex-wrap justify-center gap-2 shadow-2xl">
                    <a href="<?php echo e(route('public.gallery')); ?>" wire:navigate 
                       class="px-6 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 <?php echo e(!request('album') && !request('type') ? 'bg-gradient-to-r from-emerald-600 to-emerald-500 text-white shadow-lg shadow-emerald-500/25' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        Semua
                    </a>
                    <a href="<?php echo e(route('public.gallery', array_merge(request()->query(), ['type' => 'image']))); ?>" wire:navigate 
                       class="px-6 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 <?php echo e(request('type') == 'image' ? 'bg-gradient-to-r from-emerald-600 to-emerald-500 text-white shadow-lg shadow-emerald-500/25' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        Foto
                    </a>
                    <a href="<?php echo e(route('public.gallery', array_merge(request()->query(), ['type' => 'video']))); ?>" wire:navigate 
                       class="px-6 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 <?php echo e(request('type') == 'video' ? 'bg-gradient-to-r from-emerald-600 to-emerald-500 text-white shadow-lg shadow-emerald-500/25' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        Video
                    </a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false" 
                                class="px-6 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center gap-2 <?php echo e(request('album') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                            <?php echo e(request('album') ? Str::limit(request('album'), 15) : 'Album'); ?>
                        ...
                        <div x-show="open" 
                            ...
                            <a href="<?php echo e(route('public.gallery', array_diff_key(request()->query(), ['album' => '']))); ?>" wire:navigate 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $albums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('public.gallery', array_merge(request()->query(), ['album' => $album]))); ?>" wire:navigate 
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleries->count() > 0): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group relative rounded-[32px] overflow-hidden aspect-[4/5] bg-slate-900 border border-white/5 cursor-pointer shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:-translate-y-2 hover:border-emerald-500/30"
                             @click="
                                lightboxOpen = true; 
                                activeIndex = <?php echo e($loop->index); ?>;
                             ">
                            
                            
                            <div class="absolute inset-0">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gallery->media_type == 'video' && $gallery->thumbnail_url): ?>
                                    <img src="<?php echo e($gallery->thumbnail_url); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                ...
                                <?php elseif($gallery->image_url): ?>
                                    <img src="<?php echo e($gallery->image_url); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                            ...
                            <div class="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                <span class="align-self-start inline-flex px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-[10px] font-bold uppercase tracking-widest mb-3 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                    <?php echo e($gallery->media_type == 'video' ? 'Video' : 'Foto'); ?>
                                ...
                                <p class="text-slate-400 text-xs mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200 tracking-wide line-clamp-1">
                                    <?php echo e($gallery->description ?? 'Klik untuk melihat detail'); ?>
            ...
            <?php else: ?>
                <div class="text-center py-32 rounded-[40px] border border-dashed border-slate-800 bg-slate-900/30 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="<?php echo e(route('public.gallery')); ?>" wire:navigate class="inline-flex items-center px-8 py-3 rounded-xl bg-slate-800 text-white font-bold uppercase tracking-widest text-xs hover:bg-emerald-600 transition-all shadow-lg hover:shadow-emerald-500/25">
                            Reset Filter
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('public.layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\gallery.blade.php ENDPATH**/ ?>