        ...
        <div class="text-sm text-surface-500 dark:text-surface-400">
            <template x-if="meta.total > 0">
                <span>
                    ...
                    dari <span class="font-medium text-surface-900 dark:text-white" x-text="meta.total"></span> kategori
                </span>
            </template>
            <template x-if="meta.total === 0">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\categories\partials\pagination.blade.php ENDPATH**/ ?>