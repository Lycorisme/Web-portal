...
<div class="bg-white dark:bg-surface-900/50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-surface-200/50 dark:border-surface-800/50 p-4 sm:p-6">
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center justify-between p-3 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
            ...
            <span class="text-xl font-bold text-surface-900 dark:text-white"><?php echo e($stats['articles_count']); ?></span>
        </div>
        ...
        <div class="flex items-center justify-between p-3 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
            ...
            <span class="text-xl font-bold text-surface-900 dark:text-white"><?php echo e(number_format($stats['total_views'])); ?></span>
        </div>
        ...
        <div class="flex items-center justify-between p-3 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
            ...
            <span class="text-xl font-bold text-surface-900 dark:text-white"><?php echo e($stats['login_count']); ?></span>
        </div>
        ...
        <div class="flex items-center justify-between p-3 bg-surface-50 dark:bg-surface-800/50 rounded-xl">
            ...
            <span class="text-sm font-bold text-surface-900 dark:text-white">
                <?php echo e($stats['member_since']->format('M Y')); ?>

            </span>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\profile\partials\stats-card.blade.php ENDPATH**/ ?>