...
<div x-show="activeTab === 'content'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6 sm:space-y-8">
    ...
    <div class="group space-y-3 sm:space-y-4">
        ...
        <div class="flex items-center gap-2 sm:gap-3 px-3 py-2 bg-surface-50 dark:bg-surface-800/50 rounded-lg group-focus-within:bg-theme-50 dark:group-focus-within:bg-theme-900/10 transition-colors duration-300 overflow-hidden">
            ...
            <span class="text-[10px] sm:text-xs text-surface-400 shrink-0"><?php echo e(parse_url(config('app.url', 'example.com'), PHP_URL_HOST)); ?>/berita/</span>
            <input 
                type="text" 
    ...
    <div class="space-y-4">
        ...
        <?php echo $__env->make('articles.partials.form-modal.security-alert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        
        <?php echo $__env->make('articles.partials.form-modal.trix-editor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\articles\partials\form-modal\tab-content.blade.php ENDPATH**/ ?>