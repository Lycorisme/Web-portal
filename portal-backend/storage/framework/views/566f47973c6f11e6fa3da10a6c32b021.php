        ...
        <div class="text-sm text-surface-600 dark:text-surface-400 order-2 sm:order-1">
            <template x-if="meta.total > 0">
                <span>
                    ...
                    dari <span class="font-semibold text-surface-900 dark:text-white" x-text="meta.total"></span> IP
                </span>
            </template>
            <template x-if="meta.total === 0">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\blocked-clients\partials\pagination.blade.php ENDPATH**/ ?>