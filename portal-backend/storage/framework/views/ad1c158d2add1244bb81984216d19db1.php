...
<head>
    ...
    <title><?php echo $__env->yieldContent('meta_title', 'Beranda'); ?> | <?php echo e($siteSettings['site_name'] ?? 'BTIKP PORTAL'); ?> - Digital Excellence</title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $siteSettings['site_tagline'] ?? 'Portal Berita & Informasi'); ?>">
...
<body class="bg-[#020617] text-slate-200 overflow-x-hidden" x-data="{ mobileMenu: false }">
    ...
    <nav class="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('public.home')); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($siteSettings['logo_url']) && $siteSettings['logo_url']): ?>
                        <img class="h-12 w-auto" src="<?php echo e($siteSettings['logo_url']); ?>" alt="<?php echo e($siteSettings['site_name'] ?? 'Logo'); ?>">
                    <?php else: ?>
                ...
                <div>
                    <h1 class="text-xl font-extrabold text-white tracking-tighter leading-none">
                        <?php echo e(strtoupper($siteSettings['site_name'] ?? 'BTIKP')); ?> <span class="text-emerald-500">PORTAL</span>
                    </h1>
            ...
            <div class="hidden lg:flex items-center gap-10 text-sm font-bold tracking-wide text-slate-400">
                <a href="<?php echo e(route('public.home')); ?>" class="<?php echo e(request()->routeIs('public.home') ? 'text-emerald-500' : 'hover:text-emerald-400'); ?> transition-all">BERANDA</a>
                <a href="<?php echo e(route('public.articles')); ?>" class="<?php echo e(request()->routeIs('public.articles*') ? 'text-emerald-500' : 'hover:text-emerald-400'); ?> transition-all">BERITA</a>
                <a href="<?php echo e(route('public.gallery')); ?>" class="<?php echo e(request()->routeIs('public.gallery') ? 'text-emerald-500' : 'hover:text-emerald-400'); ?> transition-all">GALERI</a>
            ...
            <div class="flex items-center gap-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-6 py-2.5 bg-slate-800 text-white text-xs font-extrabold rounded-xl transition-all hover:bg-slate-700 uppercase">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-6 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white text-xs font-extrabold rounded-xl transition-all shadow-lg shadow-emerald-900/40 uppercase">Masuk Portal</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div x-show="mobileMenu" 
            ...
            <a href="<?php echo e(route('public.home')); ?>" class="block text-sm font-bold tracking-wide <?php echo e(request()->routeIs('public.home') ? 'text-emerald-500' : 'text-slate-400'); ?>">BERANDA</a>
            <a href="<?php echo e(route('public.articles')); ?>" class="block text-sm font-bold tracking-wide <?php echo e(request()->routeIs('public.articles*') ? 'text-emerald-500' : 'text-slate-400'); ?>">BERITA</a>
            <a href="<?php echo e(route('public.gallery')); ?>" class="block text-sm font-bold tracking-wide <?php echo e(request()->routeIs('public.gallery') ? 'text-emerald-500' : 'text-slate-400'); ?>">GALERI</a>
        </div>
    </nav>
    ...
    <footer class="bg-slate-950 border-t border-slate-900 pt-20 pb-10 mt-auto">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
            <div class="col-span-1 md:col-span-2 space-y-6">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-emerald-500 rounded-xl flex items-center justify-center font-black text-white">
                        <?php echo e(substr($siteSettings['site_name'] ?? 'B', 0, 1)); ?>

                    </div>
                    <span class="text-xl font-black text-white tracking-tighter uppercase italic"><?php echo e($siteSettings['site_name'] ?? 'BTIKP Portal'); ?></span>
                </div>
                <p class="text-slate-500 text-sm leading-relaxed max-w-sm">
                    <?php echo e($siteSettings['site_tagline'] ?? 'Pusat informasi dan transformasi teknologi komunikasi pendidikan.'); ?>
            ...
            <div>
                ...
                <ul class="space-y-4 text-slate-500 text-sm font-semibold">
                    <li><a href="<?php echo e(route('public.home')); ?>" class="hover:text-emerald-500 transition-all">Beranda</a></li>
                    <li><a href="<?php echo e(route('public.articles')); ?>" class="hover:text-emerald-500 transition-all">Berita</a></li>
                    <li><a href="<?php echo e(route('public.gallery')); ?>" class="hover:text-emerald-500 transition-all">Galeri</a></li>
        ...
        <div class="max-w-7xl mx-auto px-6 pt-10 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-xs font-bold text-slate-700 uppercase tracking-widest">© <?php echo e(date('Y')); ?> <?php echo e(strtoupper($siteSettings['site_name'] ?? 'BTIKP PORTAL')); ?>. DEVELOPED FOR DIGITAL EXCELLENCE.</p>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\layouts\public-layout.blade.php ENDPATH**/ ?>