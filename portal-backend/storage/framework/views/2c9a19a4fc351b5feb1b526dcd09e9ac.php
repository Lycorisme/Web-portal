        ...
        <div class="p-4 rounded-xl bg-white/5 border border-white/5 mt-2 transition-all" :class="{'border-brand-500/50 bg-brand-500/5': agreed}">
            <label class="flex items-start gap-3 cursor-pointer group">
                ...
                <span class="text-xs leading-relaxed group-hover:text-slate-300" :class="agreed ? 'text-brand-100' : 'text-slate-400'">
                    Saya menyetujui seluruh kebijakan privasi dan aturan keamanan data yang berlaku di <?php echo e($siteName ?? 'Portal BTIKP'); ?>.
                </span>
            </label>
        </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\auth\partials\register-form.blade.php ENDPATH**/ ?>