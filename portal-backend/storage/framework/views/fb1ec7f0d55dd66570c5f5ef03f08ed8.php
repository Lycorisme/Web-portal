...
<div class="space-y-12">
    ...
    <div class="group relative overflow-hidden rounded-[2rem] bg-slate-900/40 border border-white/5 p-8 transition-all hover:bg-slate-900/60 transition-colors duration-500">
        ...
        <div class="relative z-10">
            ...
            <form id="form-info" @submit.prevent="submitForm('form-info', '<?php echo e(route('public.profile.info')); ?>')" class="space-y-6">
    ...
    <div class="group relative overflow-hidden rounded-[2rem] bg-slate-900/40 border border-white/5 p-8 transition-all hover:bg-slate-900/60 transition-colors duration-500">
        ...
        <div class="relative z-10">
            ...
            <form id="form-password" @submit.prevent="submitForm('form-password', '<?php echo e(route('public.profile.password')); ?>')" class="space-y-6">
                <?php echo method_field('PUT'); ?>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\profile\partials\settings-tab.blade.php ENDPATH**/ ?>