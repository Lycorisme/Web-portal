...
<div class="rounded-3xl p-6 md:p-8 bg-slate-900/60 backdrop-blur-md border border-white/5 ring-1 ring-white/5 shadow-xl relative overflow-hidden group">
    ...
    <div class="flex items-center justify-between mb-8 relative z-10">
        ...
        <span class="px-3 py-1 bg-slate-800 rounded-lg text-xs font-bold text-slate-300 border border-slate-700 shadow-inner">
            <?php echo e($likedArticles->total()); ?> Item
        </span>
    </div>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($likedArticles->count() > 0): ?>
        <div class="grid gap-4 relative z-10">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $likedArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $like): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($like->article): ?>
                <a href="<?php echo e(route('public.article.show', $like->article->slug)); ?>" wire:navigate 
                   class="flex gap-5 p-4 rounded-2xl bg-slate-950/40 border border-slate-800/80 hover:bg-slate-800/50 hover:border-pink-500/30 transition-all duration-300 group/item hover:shadow-lg hover:shadow-pink-500/5 hover:-translate-y-0.5">
                    ...
                    <div class="w-24 h-24 rounded-xl overflow-hidden shrink-0 bg-slate-900 border border-slate-800 shadow-md relative">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($like->article->image_url): ?>
                            <img src="<?php echo e($like->article->image_url); ?>" class="w-full h-full object-cover group-hover/item:scale-110 transition-transform duration-500">
                        <?php else: ?>
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                <span class="px-2 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-bold text-emerald-400 uppercase tracking-wider">
                                    <?php echo e($like->article->categoryRelation?->name ?? 'Umum'); ?>

                                </span>
                                <span class="text-[10px] text-slate-500 font-medium">
                                    <i class="fas fa-calendar-alt mr-1"></i> <?php echo e($like->created_at->format('d M Y')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($likedArticles->hasPages()): ?>
            <div class="mt-8 flex justify-center">
                <?php echo e($likedArticles->links()); ?>
    ...
    <?php else: ?>
        <div class="text-center py-16 px-6 bg-slate-950/30 rounded-2xl border border-slate-800/50 border-dashed relative z-10">
            ...
            <a href="<?php echo e(route('public.articles')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all border border-slate-700 hover:border-slate-600">
                Jelajahi Berita
            </a>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<div class="rounded-3xl p-6 md:p-8 bg-slate-900/60 backdrop-blur-md border border-white/5 ring-1 ring-white/5 shadow-xl relative overflow-hidden group mt-8">
    ...
    <div class="flex items-center justify-between mb-8 relative z-10">
        ...
        <span class="px-3 py-1 bg-slate-800 rounded-lg text-xs font-bold text-slate-300 border border-slate-700 shadow-inner">
            <?php echo e($userComments->total()); ?> Item
        </span>
    </div>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userComments->count() > 0): ?>
        <div class="grid gap-4 relative z-10">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $userComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-5 rounded-2xl bg-slate-950/40 border border-slate-800/80 hover:border-blue-500/30 hover:bg-slate-900/60 transition-all duration-300 group/comment">
                    <div class="flex justify-between items-start gap-4 mb-3">
                        <div class="flex-1 min-w-0">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->article): ?>
                                <a href="<?php echo e(route('public.article.show', $comment->article->slug)); ?>" wire:navigate class="font-bold text-base text-white hover:text-blue-400 transition-colors line-clamp-1 font-display">
                        ...
                        <div class="shrink-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->status === 'visible'): ?> 
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-white/5">
                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-2">
                             <i class="far fa-clock"></i> <?php echo e($comment->created_at->diffForHumans()); ?>

                        </span>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->is_admin_reply): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userComments->hasPages()): ?>
            <div class="mt-8 flex justify-center">
                <?php echo e($userComments->links()); ?>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\profile\partials\activity-tab.blade.php ENDPATH**/ ?>