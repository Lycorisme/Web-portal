    ...
    <div class="relative z-10">
        <div class="flex items-center gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoUrl): ?>
                <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($siteName); ?>" class="h-12 w-auto rounded-xl shadow-lg shadow-brand-500/20">
            <?php else: ?>
            ...
            <span class="text-xl font-bold tracking-tight text-white"><?php echo e($siteName); ?></span>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\auth\partials\login-left-panel.blade.php ENDPATH**/ ?>