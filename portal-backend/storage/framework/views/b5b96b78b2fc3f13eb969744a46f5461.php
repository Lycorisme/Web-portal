...
<div class="modal-overlay" id="loginModal" x-data="{ open: false }" x-show="open" @keydown.escape.window="open = false" style="display: none;">
    <div class="modal" @click.away="open = false">
        ...
        <div class="modal-actions">
            ...
            <a href="<?php echo e(route('login', ['intended' => url()->current()])); ?>" class="btn btn-primary">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\public\layouts\partials\public-scripts.blade.php ENDPATH**/ ?>