...
function profilePage() {
    return {
        ...
        hasPhoto: <?php echo e($user->profile_photo ? 'true' : 'false'); ?>,
        ...
        formData: {
            ...
            location: '<?php echo e($user->location ?? ""); ?>',
        },
        ...
        async deletePhoto() {
            showConfirm(
                ...
                async () => {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route("profile.photo.delete")); ?>', {
                            method: 'DELETE',
                            headers: {
        ...
        async saveProfileInfo() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("profile.info.update")); ?>', {
                    method: 'PUT',
        ...
        async updatePassword() {
            ...
            try {
                const response = await fetch('<?php echo e(route("profile.password.update")); ?>', {
                    method: 'PUT',
        ...
        async logoutAllDevices() {
            ...
            try {
                const response = await fetch('<?php echo e(route("profile.logout-all-devices")); ?>', {
                    method: 'POST',
                    body: JSON.stringify({
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\profile\partials\scripts.blade.php ENDPATH**/ ?>