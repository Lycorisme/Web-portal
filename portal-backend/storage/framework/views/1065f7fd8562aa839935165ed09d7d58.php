...
<head>
    ...
    <title><?php echo e($siteName); ?> - Access Point</title>
    ...
    <?php echo $__env->make('auth.partials.login-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</head>
<body class="min-h-screen relative flex items-center justify-center p-4 overflow-x-auto selection:bg-brand-500/30 zoom-wrapper">
    ...
    <div class="relative z-10 w-full min-w-[900px] max-w-[1200px] h-[85vh] min-h-[650px] max-h-[850px] glass-card rounded-[32px] overflow-hidden flex flex-row shadow-2xl zoom-container">
        ...
        <?php echo $__env->make('auth.partials.login-left-panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div x-data="authPanel()" class="flex-1 md:flex-none w-full md:w-[50%] relative bg-[#0b1120]/80 flex flex-col h-full">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar p-8 md:p-14 2xl:p-16 relative">
                ...
                <?php echo $__env->make('auth.partials.login-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('auth.partials.register-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('auth.partials.reset-password-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('auth.partials.verify-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
    ...
    <?php echo $__env->make('auth.partials.login-scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html><?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\auth\login.blade.php ENDPATH**/ ?>