    ...
    showConfirm(
        ...
        async () => {
            try {
                ...
                const response = await fetch('<?php echo e(route("articles.bulk-destroy")); ?>', {
                    method: 'DELETE',
                    headers: {
    ...
    showConfirm(
        ...
        async () => {
            try {
                ...
                const response = await fetch('<?php echo e(route("articles.bulk-restore")); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                        'Accept': 'application/json',
    ...
    showConfirm(
        ...
        async () => {
            try {
                ...
                const response = await fetch('<?php echo e(route("articles.bulk-force-delete")); ?>', {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                        'Accept': 'application/json',
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\articles\partials\scripts\bulk-actions.blade.php ENDPATH**/ ?>