...
async submitForm() {
    ...
    try {
        const url = this.formMode === 'create' ? '<?php echo e(route("categories.store")); ?>' : `/categories/${this.formData.id}`;
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\categories\partials\scripts\form.blade.php ENDPATH**/ ?>