...
<div x-show="activeTab === 'signature'" 
     x-data="{
        leader_title: '<?php echo e(addslashes($rawSettings['leader_title'] ?? '')); ?>',
        leader_name: '<?php echo e(addslashes($rawSettings['leader_name'] ?? '')); ?>',
        leader_nip: '<?php echo e(addslashes($rawSettings['leader_nip'] ?? '')); ?>',
        signature_cc: `<?php echo e($rawSettings['signature_cc'] ?? ''); ?>`, // Gunakan backtick untuk multiline
        city: '<?php echo e(addslashes($rawSettings['letterhead_city'] ?? $rawSettings['site_city'] ?? 'Kota')); ?>',
        date: '<?php echo e(date('d F Y')); ?>',
        
        // Size controls (in pixels)
        signatureSize: <?php echo e($rawSettings['signature_size'] ?? 80); ?>,
        stampSize: <?php echo e($rawSettings['stamp_size'] ?? 85); ?>,
        ...
        sigUrl: '<?php echo e($rawSettings['signature_url'] ?? ''); ?>',
        stampUrl: '<?php echo e($rawSettings['stamp_url'] ?? ''); ?>',
        deleteSig: false,
        deleteStamp: false
     }"
                ...
                <div class="space-y-4 pt-4">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            >
                            <input type="hidden" name="signature_url_current" value="<?php echo e($rawSettings['signature_url'] ?? ''); ?>">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            >
                            <input type="hidden" name="stamp_url_current" value="<?php echo e($rawSettings['stamp_url'] ?? ''); ?>">
                        ...
                        <div class="flex justify-end mb-8 relative">
                            ...
                            <div class="w-64 text-center relative z-10">
                                ...
                                <div class="relative flex items-center justify-center my-2 transition-all duration-300" :style="'min-height: ' + Math.max(signatureSize, stampSize) + 'px'">
                                    ...
                                    <img x-ref="previewSig" src="<?php echo e(!empty($rawSettings['signature_url']) ? asset($rawSettings['signature_url']) : ''); ?>" 
                                         class="w-auto object-contain relative z-20 transition-all duration-300" 
                                         :style="'height: ' + signatureSize + 'px; <?php echo e(!empty($rawSettings['signature_url']) ? '' : 'display: none;'); ?>'"
                                         alt="Signature">
                                         
                                    <div x-show="!$refs.previewSig.src && !'<?php echo e($rawSettings['signature_url'] ?? ''); ?>'" class="border border-dashed border-surface-300 p-2 rounded text-xs text-surface-400">
                                        [Area Tanda Tangan]
                                    </div>

                                    
                                    <img x-ref="previewStamp" src="<?php echo e(!empty($rawSettings['stamp_url']) ? asset($rawSettings['stamp_url']) : ''); ?>" 
                                         class="w-auto object-contain absolute left-0 z-10 opacity-80 rotate-[-10deg] transition-all duration-300" 
                                         :style="'height: ' + stampSize + 'px; left: -10px; <?php echo e(!empty($rawSettings['stamp_url']) ? '' : 'display: none;'); ?>'"
                                         alt="Stamp">
                                </div>
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\settings\partials\signature.blade.php ENDPATH**/ ?>