...
<head>
    ...
    <title><?php echo e($siteName); ?> - Verifikasi Email</title>
...
<body class="min-h-screen relative flex items-center justify-center p-4 overflow-hidden selection:bg-brand-500/30">
    ...
    <div class="relative z-10 w-full max-w-md glass-card rounded-3xl overflow-hidden shadow-2xl p-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm">Kode OTP telah dikirim ke <span class="text-white font-medium"><?php echo e($email); ?></span></p>
        </div>
        ...
        <form action="<?php echo e(route('verification.verify')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-2">
                ...
                <input type="text" 
                       ...
                       required
                       maxlength="6"
                       class="w-full px-5 py-4 rounded-xl modern-input text-white placeholder-slate-600 text-center text-2xl font-mono tracking-[0.5em] font-bold <?php $__errorArgs = ['otp'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mt-6 text-center">
            ...
            <div class="mt-8 pt-6 border-t border-white/5">
                <a href="<?php echo e(route('login')); ?>" class="text-xs font-medium text-slate-500 hover:text-white transition-colors flex items-center justify-center gap-2 group">
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>