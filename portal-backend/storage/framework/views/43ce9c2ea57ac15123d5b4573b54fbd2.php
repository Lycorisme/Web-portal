...
async openAutoDeleteModal() {
    try {
        ...
        const response = await fetch('<?php echo e(route('activity-log.settings')); ?>');
...
async saveAutoDeleteSettings() {
    ...
    try {
        const response = await fetch('<?php echo e(route('activity-log.settings.update')); ?>', {
            method: 'PUT',
            headers: {
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\activity-log\partials\scripts\auto-delete.blade.php ENDPATH**/ ?>