                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="site_address" id="contact_site_address" rows="3"
                            ...
                            placeholder="Jl. Contoh No. 123, Kelurahan, Kecamatan, Kota, Provinsi"><?php echo e($rawSettings['site_address'] ?? ''); ?></textarea>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="site_email" id="contact_site_email"
                            value="<?php echo e($rawSettings['site_email'] ?? ''); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="site_phone" id="contact_site_phone"
                            value="<?php echo e($rawSettings['site_phone'] ?? ''); ?>"
                            class="w-full pl-16 pr-4 py-3 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl text-surface-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="whatsapp_number" id="whatsapp_number"
                            value="<?php echo e($rawSettings['whatsapp_number'] ?? ''); ?>"
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="site_history" id="site_history" rows="6"
                        ...
                        placeholder="Ceritakan sejarah singkat organisasi Anda..."><?php echo e($rawSettings['site_history'] ?? ''); ?></textarea>
...
1. Melaksanakan...
2. Mengembangkan...
3. Meningkatkan..."><?php echo e($rawSettings['site_vision_mission'] ?? ''); ?></textarea>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="site_map_code" id="site_map_code" rows="4"
                        ...
                        placeholder='<iframe src="https://www.google.com/maps/embed?pb=..." width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>'><?php echo e($rawSettings['site_map_code'] ?? ''); ?></textarea>
                </div>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($rawSettings['site_map_code'])): ?>
                <div class="space-y-2">
                    <label class="block text-sm font-medium text-surface-700 dark:text-surface-300">
                        Preview Peta
                    </label>
                    <div class="w-full h-64 rounded-xl overflow-hidden border border-surface-200 dark:border-surface-700">
                        <?php echo $rawSettings['site_map_code']; ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="facebook_url" id="facebook_url"
                            value="<?php echo e($rawSettings['facebook_url'] ?? ''); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="instagram_url" id="instagram_url"
                            value="<?php echo e($rawSettings['instagram_url'] ?? ''); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="twitter_url" id="twitter_url"
                            value="<?php echo e($rawSettings['twitter_url'] ?? ''); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="youtube_url" id="youtube_url"
                            value="<?php echo e($rawSettings['youtube_url'] ?? ''); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="tiktok_url" id="tiktok_url"
                            value="<?php echo e($rawSettings['tiktok_url'] ?? ''); ?>"
                            class="w-full pl-16 pr-4 py-3 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl text-surface-900 dark:text-white focus:ring-2 focus:ring-surface-500 focus:border-transparent transition-all duration-200"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="linkedin_url" id="linkedin_url"
                            value="<?php echo e($rawSettings['linkedin_url'] ?? ''); ?>"
...
<?php /**PATH C:\laragon\www\web-portal\portal-backend\resources\views\settings\partials\contact.blade.php ENDPATH**/ ?>