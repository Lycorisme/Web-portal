...
<div class="bg-white dark:bg-surface-900/50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-surface-200/50 dark:border-surface-800/50 p-4 sm:p-6 lg:p-8">
    <div class="flex flex-col items-center text-center">
        ...
        <div class="relative group mb-4 sm:mb-6">
            <div class="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-2xl sm:rounded-3xl overflow-hidden ring-4 ring-surface-200 dark:ring-surface-700 shadow-xl transition-all duration-300 group-hover:ring-theme-500">
            ...
            {{-- Online Status Badge --}}
            <div class="absolute -bottom-2 -right-2 w-8 h-8 bg-accent-emerald rounded-full border-4 border-white dark:border-surface-900 flex items-center justify-center">
        ...
        <div class="w-full mt-6 space-y-3">
            <button @click="showPhotoModal = true"
                    class="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-theme-gradient text-white rounded-xl font-medium shadow-theme hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200">
